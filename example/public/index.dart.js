...
main_closure: {"": "Closure;button_0",
  call$1: function($event) {
    var t1 = this.button_0;
    if (t1.textContent === "Again!") {
      t1.textContent = "Press me!";
      t1 = t1.style;
      t1.set$color;
      $.setProperty$3$x(t1, "color", null, "");
    } else {
      t1.textContent = "Again!";
      t1 = t1.style;
      t1.set$color;
      $.setProperty$3$x(t1, "color", "red", "");
    }
  }
},
...
main: function() {
  ...
  t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.main_closure(button), t1._useCapture);
  t2 = t1._onData;
