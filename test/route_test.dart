...
main() {
  ...
  group('works', () {
    test('without optionnal', () {
      ...
      expect(route.urlPattern, r'/api/(library:\w+)/(controller:\w+)-(action:\w+)');
    ...
    test('with additional parameter', () {
      ...
      expect(route.urlPattern, r'/api/(library:\w+)/(controller:\w+)-(action:\w+)/(id:\w+)');
    ...
    test('without needed segment', () {
      ...
      expect(route.urlPattern, r'/api/(controller:\w+)-(action:\w+)');
